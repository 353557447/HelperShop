...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mWaveColor = Color.parseColor("#be30ADFD");
        mTextColorChoose = context.getResources().getColor(android.R.color.white);
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.font_10);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.font_28);
        ...
        if (attrs != null) {
            ...
            mBallRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.dp_25));
            a.recycle();
        }
