...
package com.shuiwangzhijia.shuidian.wheelview;
...
import com.shuiwangzhijia.shuidian.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.color_30adfd));
        // 设置线宽
