...
public class ReturnMoneyRecordProgressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReturnMoneyRecordProgressAdapter(Context context, int type) {
