...
public class SpEarnWdRecordDetailsAdapter extends RecyclerView.Adapter<SpEarnWdRecordDetailsAdapter.ViewHolder> {
    private SimpleDateFormat mSimpleDateFormat;
    private Context mContext;
    private List<SpEarnRecordDetailsBean.DataBean> data;

    public SpEarnWdRecordDetailsAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_sp_earn_freezing, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        SpEarnRecordDetailsBean.DataBean dataBean = data.get(position);
    ...
    public void setData(List<SpEarnRecordDetailsBean.DataBean> data) {
        this.data = data;
    }
