...
//        Toast.makeText(context, text, Toast.LENGTH_SHORT).show();
    ...
    public void onNotifactionShowedResult(Context context,
        ...
        notific.setCustom_content(notifiShowedRlt.getCustomContent());
        ...
        String replaceAll = content.replaceAll("\\d+", "");
        XunFeiUtils.init(context).startSpeaking(replaceAll, null);
        //customContent={"status":2}, 2水票提醒 1 优惠券 3 订单
         if(!TextUtils.isEmpty(notifiShowedRlt.getCustomContent())){
             JSONObject jsonObject = null;
             try {
                 jsonObject = new JSONObject(notifiShowedRlt.getCustomContent());
